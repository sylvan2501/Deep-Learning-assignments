...
Original file is located at
    https://colab.research.google.com/drive/1Y0zLqeR0rInNC-Ovmm-pOAi-vMYpOoqX
...
def train_val_split(time, series, time_step=SPLIT_TIME):
    ...
    ### START CODE HERE
    time_train = time[0:time_step]
    series_train = series[0:time_step]
...
def compute_metrics(true_series, forecast):
    ...
    mae=mae(true_series, forecast).numpy()
    ### END CODE HERE
